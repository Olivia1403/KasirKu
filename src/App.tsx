            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 bg-white rounded-3xl border border-slate-200 shadow-sm">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input disabled value="Kedai Kopi UMKM" className="w-full px-4 py-3 bg-slate-50 border-none rounded-xl text-slate-500 font-medium cursor-not-allowed" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Alamat</label>
                    <textarea disabled value="Jl. Merdeka No. 123, Jakarta" className="w-full px-4 py-3 bg-slate-50 border-none rounded-xl text-slate-500 font-medium cursor-not-allowed resize-none h-24" />
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-white rounded-3xl border border-slate-200 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-bold text-red-600">Reset Data</p>
                      <p className="text-sm text-slate-500">Hapus semua produk dan transaksi.</p>
                    </div>
                    <button 
                      onClick={() => {
